...
export default function ShortStories() {
  ...
  const bookKey = "A Subway At AIIMS"; // matches JSON key
  ...
  return (
   ...
   {/* Download Button */}
<a
  href="https://udhav-saraswat.github.io/blogs/images/A_Subway_At_AIIMS.pdf"
  target="_blank"
  className="
...
>
  ...
  Download PDF
      ...
      {/* Book Cover */}
      <img
        src="https://udhav-saraswat.github.io/blogs/images/coverAiims.png"
        alt="Book Cover"
        className="
          mt-10 
          w-[350px] md:w-[420px]
